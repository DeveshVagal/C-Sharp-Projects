...
namespace BSCITATTENDENCE
{
    public partial class StudentYearlyAttendence : Form
    {
        ...
        private void StudentYearlyAttendence_Load(object sender, EventArgs e)
        {
            label4.Text = LoginPage.passingText;
        }

        private void StudentYearlyAttendence_FormClosed(object sender, FormClosedEventArgs e)
        {
