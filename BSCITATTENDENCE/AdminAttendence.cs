...
{
    public partial class AdminAttendence : Form
    {
        ...
        private void AdminAttendence_Load(object sender, EventArgs e)
        {
        ...
        private void AdminAttendence_FormClosed(object sender, FormClosedEventArgs e)
        {
            AdminSection aaa = new AdminSection();
            aaa.Show();
            this.Hide();
        }
